...
sns.heatmap(cor)
plt.title("训练数据特征热图")
plt.savefig("SVM_train_heatmap.png")
plt.show()
...
sns.heatmap(cor)
plt.title("测试数据特征热图")
plt.savefig("SVM_test_heatmap.png")
plt.show()
...
score=[[]]
for k in ker:
    model = svm.SVC(kernel=k,random_state=420)
    ...
    score.append(co)
score=score[1:]
score=pd.DataFrame(score,columns=["Sn","Sp","KER"])
plt.plot(score["Sp"],score["Sn"],marker='^',markeredgecolor='black')
plt.title("Sp-Sn折线图")
plt.xlabel("Sp值")
plt.ylabel("Sn值")
plt.savefig("SVM_Sn_Sp.png")
plt.show()
plt.plot(score["KER"],score["Sp"],marker='^',markeredgecolor='black')
plt.title("核函数-Sp折线图")
plt.xlabel("核函数种类")
plt.ylabel("Sp值")
plt.savefig("SVM_KER_Sp.png")
plt.show()
plt.plot(score["KER"],score["Sn"],marker='^',markeredgecolor='black')
plt.title("核函数-Sn折线图")
plt.xlabel("核函数种类")
plt.ylabel("Sn值")
plt.savefig("SVM_KER_Sn.png")
plt.show()
